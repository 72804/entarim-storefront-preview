  ...
  return (
    <StorefrontShell>
      <main className="mx-auto w-[min(calc(100%-2rem),720px)] py-24 text-center">
        <p className="text-xs font-extrabold uppercase tracking-[0.18em] text-rose-600">404</p>
        ...
        <Link
          className="mt-8 inline-flex rounded-full bg-rose-800 px-6 py-3 text-sm font-bold text-white"
          href="/"
        >
          Ana sayfaya dön
        </Link>
